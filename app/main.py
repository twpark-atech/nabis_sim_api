...
from app.api.v1.scenarios_bridge import router as scenarios_bridge_router
...
app.include_router(scenarios_bridge_router, prefix="/api/v1/scenarios", tags=["scenarios"])
